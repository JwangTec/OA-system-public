...
import git.jwang.oasys.model.dao.scheduledao.ScheduleDao;
...
import git.jwang.oasys.model.dao.user.UserLogRecordService;
import git.jwang.oasys.model.dao.user.UserLogService;
...
public class UserLogController {
	...
	public String test3df(HttpServletResponse response) throws IOException {
		...
		for (User user : uList) {
		 ...
		 ArrayList<Entry<String,Integer>> entries= sortMap(hashMap);
