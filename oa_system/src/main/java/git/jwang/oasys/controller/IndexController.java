package git.jwang.oasys.controller;
...
import git.jwang.oasys.mappers.NoticeMapper;
import git.jwang.oasys.model.dao.attendcedao.AttendceDao;
import git.jwang.oasys.model.dao.daymanagedao.DaymanageDao;
import git.jwang.oasys.model.dao.discuss.DiscussDao;
import git.jwang.oasys.model.dao.filedao.FileListdao;
import git.jwang.oasys.model.dao.informdao.InformRelationDao;
import git.jwang.oasys.model.dao.maildao.MailreciverDao;
import git.jwang.oasys.model.dao.notedao.DirectorDao;
import git.jwang.oasys.model.dao.plandao.PlanDao;
import git.jwang.oasys.model.dao.processdao.NotepaperDao;
import git.jwang.oasys.model.dao.processdao.ProcessListDao;
...
import git.jwang.oasys.model.dao.taskdao.TaskuserDao;
import git.jwang.oasys.model.dao.user.UserDao;
import git.jwang.oasys.model.dao.user.UserLogDao;
import git.jwang.oasys.model.entity.attendce.Attends;
import git.jwang.oasys.model.entity.mail.Mailreciver;
import git.jwang.oasys.model.entity.notice.NoticeUserRelation;
import git.jwang.oasys.model.entity.notice.NoticesList;
import git.jwang.oasys.model.entity.plan.Plan;
import git.jwang.oasys.model.entity.process.Notepaper;
import git.jwang.oasys.model.entity.process.ProcessList;
import git.jwang.oasys.model.entity.role.Rolemenu;
import git.jwang.oasys.model.entity.schedule.ScheduleList;
import git.jwang.oasys.model.entity.system.SystemStatusList;
import git.jwang.oasys.model.entity.system.SystemTypeList;
import git.jwang.oasys.model.entity.task.Taskuser;
import git.jwang.oasys.model.entity.user.User;
import git.jwang.oasys.model.entity.user.UserLog;
import git.jwang.oasys.services.daymanage.DaymanageServices;
import git.jwang.oasys.services.inform.InformRelationService;
import git.jwang.oasys.services.inform.InformService;
import git.jwang.oasys.services.system.MenuSysService;
